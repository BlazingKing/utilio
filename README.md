...
## เครื่องมือปัจจุบัน (44 รายการ / 5 หมวด)

| หมวด | เครื่องมือ |
| --- | --- |
| เครื่องมือไทย | จำนวนเงินเป็นตัวหนังสือ (บาทถ้วน), แปลงปี พ.ศ. ↔ ค.ศ., ตรวจเลขบัตรประชาชน, แปลงเลขไทย ↔ อารบิก, คำนวณ VAT 7%, สร้าง QR พร้อมเพย์, คำนวณภาษีเงินได้บุคคลธรรมดา, คำนวณเงินเดือนสุทธิ, แปลงหน่วยที่ดินไทย |
...
| สำหรับนักพัฒนา | URL Encode/Decode, สร้าง UUID, สร้าง Hash (SHA), แปลง Timestamp, ถอดรหัส JWT, สร้างรหัสผ่าน, แปลง CSV ↔ JSON, ทดสอบ Regex, แปลงเลขฐาน, อธิบาย Cron, แปลง JSON ↔ YAML, Escape / Unescape |
