...
## เครื่องมือปัจจุบัน (36 รายการ / 5 หมวด)
...
| สำหรับนักพัฒนา | URL Encode/Decode, สร้าง UUID, สร้าง Hash (SHA), แปลง Timestamp, ถอดรหัส JWT, สร้างรหัสผ่าน, แปลง CSV ↔ JSON, ทดสอบ Regex, แปลงเลขฐาน, อธิบาย Cron |
| คำนวณ & แปลงหน่วย | แปลงหน่วย, คำนวณเปอร์เซ็นต์, คำนวณอายุ / นับวัน, สุ่มรายชื่อ / สุ่มเลข, หารค่าใช้จ่าย, คำนวณสินเชื่อ / ผ่อนชำระ, คำนวณ BMI |
